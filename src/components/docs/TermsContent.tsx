  ...
  return (
    <>
      ...
      <DocsSection title="9. 책임 제한">
        간접·특별·결과적 손해에 책임을 지지 않습니다. 메랜고의 총 책임 한도는
