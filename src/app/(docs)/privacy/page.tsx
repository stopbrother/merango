const page = () => {
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 space-y-6">
      ...
      <section>
        <h2 className="text-lg font-medium ">2. 개인정보의 이용 목적</h2>
      ...
      <section>
        <h2 className="text-lg font-medium">3. 보유 및 이용 기간</h2>
        <ul className="list-disc ml-5 space-y-1">
      ...
      <section>
        <h2 className="text-lg font-medium ">4. 제3자 제공</h2>
        <p>
          서비스는 이용자의 개인정보를 외부에 제공하지 않습니다. 다만, 법령에
          의한 요구가 있거나 이용자의 사전 동의가 있는 경우에 한하여 필요한 범위
          내에서 제공할 수 있습니다.
        </p>
        <p className="text-sm text-muted-foreground">
      ...
      <section>
        <h2 className="text-lg font-medium ">5. 처리의 위탁</h2>
      ...
      <section>
        <h2 className="text-lg font-medium">6. 국외 이전</h2>
        <ul className="list-disc ml-5 space-y-1">
          <li>
      ...
      <section>
        <h2 className="text-lg font-medium">7. 이용자의 권리와 행사 방법</h2>
        <p>이용자는 개인정보에 대해 열람, 정정, 삭제를 요구할 수 있습니다.</p>
        <ul className="list-disc ml-5 space-y-1">
          <li>
      ...
      <section>
        <h2 className="text-lg font-medium">8. 개인정보의 파기 절차 및 방법</h2>
      ...
      <section>
        <h2 className="text-lg font-medium">9. 개인정보 보호를 위한 조치</h2>
        <ul className="list-disc ml-5 space-y-1">
          <li>
      ...
      <section>
        <h2 className="text-lg font-medium">쿠키</h2>
        <p>
          로그인 상태 유지를 위해 세션 쿠키를 사용합니다. 브라우저 설정으로
          저장을 거부할 수 있으나 일부 기능이 제한될 수 있습니다.
        </p>
      </section>

      <section>
        <h2 className="text-lg font-medium ">10. 문의처</h2>
        <p>
